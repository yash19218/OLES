...
echo "<h2 style='text-align:center;color:blue;'>Hello,".$_SESSION['login']."</h2>";
  ...
  // </tr>
 echo' <tr>
    <td height="58" valign="bottom"><img src="image/course.png" width="43" height="43" align="absmiddle"></td>
    <td valign="bottom"> <a href="courses.php" class="style4">Course </a></td>
  </tr>
</table>';
